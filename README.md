...
GRANT USAGE ON SCHEMA public TO team19;
GRANT CREATE ON SCHEMA public TO team19;
GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA public TO team19;
GRANT USAGE, SELECT, UPDATE ON ALL SEQUENCES IN SCHEMA public TO team19;
\q
```
